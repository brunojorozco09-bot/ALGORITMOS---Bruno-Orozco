...
function calculo() {
  ...
  let valorProcesador = Number(procesador.options[procesador.selectedIndex].value);
  let valorMonitor = Number(monitor.options[monitor.selectedIndex].value);
  let valorDisco = Number(disco.options[disco.selectedIndex].value);
